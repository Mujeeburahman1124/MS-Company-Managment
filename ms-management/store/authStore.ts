  ...
  initStore: async () => {
    try {
      const [
        ...
        fetch("/api/own-companies").then(r => r.ok ? r.json() : []),
        ...
        fetch("/api/placement").then(r => r.ok ? r.json() : []),
        ...
        fetch("/api/overtime").then(r => r.ok ? r.json() : []),
        fetch("/api/corrections").then(r => r.ok ? r.json() : []),
        fetch("/api/emails").then(r => r.ok ? r.json() : []),
        fetch("/api/whatsapp").then(r => r.ok ? r.json() : []),
