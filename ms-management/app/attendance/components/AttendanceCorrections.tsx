...
export default function AttendanceCorrections() {
  const { currentRole, currentUser, attendanceCorrections, updateAttendanceCorrection, deleteAttendanceCorrection, addActivityLog, staff, hasPermission } = useAuthStore();
