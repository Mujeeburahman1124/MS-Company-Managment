                    ...
                    <div>
                      ...
                      <p className="mt-0.5">
                        <span className={`px-2 py-0.5 rounded text-[10px] font-bold ${
                          selectedAppPlacement.agreementStatus === "Signed" 
                      ...
                      <div key={int.id} className="border border-slate-200 rounded-xl p-3 bg-slate-50/50 flex flex-col gap-2">
                        <div className="flex justify-between items-start">
                          ...
                          <span className={`px-2 py-0.5 rounded text-[9px] font-extrabold uppercase ${
                            int.status === "Scheduled" ? "bg-blue-50 text-blue-600 border border-blue-100" : "bg-emerald-50 text-emerald-600 border border-emerald-100"
                          }`}>
                            {int.status}
                          </span>
                        </div>
